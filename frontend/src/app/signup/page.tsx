        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-surface-light to-background px-4 py-12">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-text-secondary">Join FlowTask today</p>
                </div>
                ...
                <div className="bg-surface rounded-2xl shadow-xl p-8 border border-border">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-xs text-text-secondary">Password must be at least 6 characters</p>
                        </div>
                        ...
                        <div className="flex items-start">
                            <input
                                ...
                                type="checkbox"
                                required
                                className="mt-1 h-4 w-4 text-primary focus:ring-primary border-border rounded bg-surface-light"
                            />
